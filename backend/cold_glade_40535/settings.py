"""
Django settings for cold_glade_40535 project.
...
ROOT_URLCONF = 'cold_glade_40535.urls'
...
WSGI_APPLICATION = 'cold_glade_40535.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_glade_40535 API",
    "DESCRIPTION": "API documentation for cold_glade_40535 App",
    "VERSION": "v1",
}
